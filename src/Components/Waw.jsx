  ...
  return (
    <div className="scroll-smooth mt-20">
      ...
      >
        <h1
          data-aos="zoom-in"
          className="text-3xl text-white text-center mt-10 sm:text-4xl md:text-5xl lg:text-5xl font-semibold tracking-wider mb-16 leading-tight min-h-[4rem] sm:min-h-[5rem] md:min-h-[6rem]"
        >
          ABOUT US
        </h1>
