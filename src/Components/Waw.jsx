...
const About = () => {
  return (
    <div className="scroll-smooth">
      <div
        id="about"
        className="relative w-full px-3 lg:px-5 py-16 mb-0 bg-cover bg-center bg-no-repeat bg-fixed"
        // style={{ backgroundImage: `url(${back})` }}
      >
        <div className="absolute inset-0 bg-[#F3F2EC] z-0" />
        <div className="relative z-10">
          ...
          <div className="w-full flex flex-col lg:flex-row items-center bg-cover bg-center bg-no-repeat bg-fixed px-3 lg:px-4 py-10 lg:py-16 mb-20 bg-[#1B3C53]">
            <div className="lg:w-1/2 w-full text-white bg-black/70 p-5  backdrop-blur-sm">
              ...
              <p className="lg:text-[16px] text-[16px]  mb-6">
            ...
            <div className="lg:w-1/2 w-full mt-4 lg:mt-0">
              <img src={solar} alt="AI/ML Services" className="w-full h-auto object-cover shadow-2xl " />
            </div>
          </div>
          ...
          <div className="w-full flex flex-col lg:flex-row-reverse items-center bg-cover bg-center bg-no-repeat bg-fixed px-3 lg:px-4 py-10 lg:py-16 mb-10 bg-[#1B3C53]" >
            ...
            <div className="lg:w-1/2 w-full mt-4 lg:mt-0">
              <img src={tech} alt="Tech services" className="w-full h-auto object-cover shadow-2xl" />
            </div>
          </div>
        </div>
      </div>
